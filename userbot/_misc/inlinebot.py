...
@tgbot.on(callbackquery.CallbackQuery(data=re.compile(b"errickow")))
async def on_plugin_callback_query_handler(event):
    await event.edit(
        file=ilhammansiez,
        link_preview=True,
        buttons=[
            Button.url("🤖 SUPPORT 🤖", "https://t.me/Pamerdong"),
            Button.url(" Creator ", "https://t.me/Chakszzz"),
